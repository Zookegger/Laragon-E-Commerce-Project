...
<div class="container">
    <div class="card mx-auto" style="max-width: 800px;">
        ...
        <div class="card-footer d-flex justify-content-between py-2">
            <a href="/webbanhang/category" class="btn btn-lg btn-outline-secondary">Return to list</a>
            <button type="submit" form="edit_category" class="btn btn-lg btn-primary">Update Category</button>
        </div>
    </div>
</div>
